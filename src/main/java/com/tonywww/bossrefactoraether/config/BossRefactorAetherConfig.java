    ...
    public static final class SliderCombatConfig {
        ...
        private SliderCombatConfig(ForgeConfigSpec.Builder builder) {
            ...
            fullPickaxeAttackStrength = defineDouble(builder,
                    ...
                    "满蓄力镐攻击所需的攻击强度。");
            blockBreakSampleStep = defineDouble(builder, "block_break_sample_step",
                    SliderMechanics.BLOCK_BREAK_SAMPLE_STEP, 0.05, 4.0,
                    "Distance between block-breaking samples.", "方块破坏扫描的采样间距。");
            maxBlockBreakSamples = defineInt(builder, "max_block_break_samples",
    ...
    public static final class ValkyrieQueenRangeConfig {
        ...
        private ValkyrieQueenRangeConfig(ForgeConfigSpec.Builder builder) {
            ...
            diagonalHalfAngle = defineAngle(builder, "diagonal_slash_half_angle",
                    ValkyrieQueenMechanics.DIAGONAL_HALF_ANGLE, "Diagonal-slash half-angle.", "砍击扇形半角。");
            horizontalHalfAngle = defineAngle(builder, "horizontal_slash_half_angle",
                    ValkyrieQueenMechanics.HORIZONTAL_HALF_ANGLE, "Horizontal-slash half-angle.", "横斩扇形半角。");
            verticalHalfAngle = defineAngle(builder, "vertical_chop_half_angle",
                    ValkyrieQueenMechanics.VERTICAL_HALF_ANGLE, "Vertical-chop half-angle.", "竖劈扇形半角。");
            ...
            swordWaveDistance = defineDistance(builder, "sword_wave_distance",
                    ValkyrieQueenMechanics.SWORD_WAVE_DISTANCE, "Sword-wave travel distance.", "剑气飞行距离。");
            ...
            dashDistance = defineDistance(builder, "skill_two_dash_distance",
                    ValkyrieQueenMechanics.DASH_DISTANCE, "Martial Skill II dash distance.", "武神技二突进距离。");
            ...
            spearRetrieveSpeed = defineSpeedMultiplier(builder, "spear_retrieve_speed",
                    ValkyrieQueenMechanics.SPEAR_RETRIEVE_SPEED, "Spear-retrieval speed.", "回收长枪速度。");
            skillTwoSpinRadius = defineDistance(builder, "skill_two_spin_radius",
                    ValkyrieQueenMechanics.SKILL_TWO_SPIN_RADIUS, "Martial Skill II spin radius.", "武神技二回旋半径。");
            basicLanceSpinRadius = defineDistance(builder, "basic_lance_spin_radius",
                    ValkyrieQueenMechanics.BASIC_LANCE_SPIN_RADIUS, "Basic follow-up spin radius.", "基本技追加回旋半径。");
            spearImpactRadius = defineDistance(builder, "spear_impact_radius",
                    ValkyrieQueenMechanics.SPEAR_IMPACT_RADIUS, "Spear-impact radius.", "长枪落点伤害半径。");
            thunderCloudRadius = defineDistance(builder, "thunder_cloud_radius",
                    ValkyrieQueenMechanics.THUNDER_CLOUD_RADIUS, "Thunder-cloud radius.", "雷云水平半径。");
